...
export const translations = {
  en: {
    ...
    // Workspace
    workspaceBadge: "AI-Powered Chart Generation",
    workspaceH2: "Transform Your PRD into Visual Charts",
