...
export const translations = {
  en: {
    ...
    heroDesc: "Built for product managers and developers. Upload your PRD, AI instantly generates mermaid sequence diagrams, flowcharts, and journey maps.",
    ...
    // Workspace
    workspaceBadge: "AI-Powered Mermaid Chart Generation",
    workspaceH2: "Transform Your PRD into Mermaid Charts",
    workspaceDesc: "Paste your PRD text or upload a .txt file. Our AI will analyze and generate professional mermaid diagrams instantly.",
    typeLabel: "Diagram Type",
    typeSequence: "Sequence Diagram",
    typeSequenceDesc: "Mermaid sequence diagram flows",
    typeFlowchart: "Flowchart",
    typeFlowchartDesc: "Mermaid flowchart visualization",
    typeJourney: "User Journey Map",
    typeJourneyDesc: "Mermaid journey map",
    generateBtn: "Generate Diagram",
    downloadBtn: "Download Mermaid Diagram",
    ...
    doneLabel: "Mermaid diagram generated successfully",
    sliderHint: "Preview your generated mermaid diagram",
    resolution: "resolution",
    preview: "Preview",
    change: "Change",
    labelOriginal: "Original Text",
    labelEnhanced: "Generated Mermaid Diagram",

    // Features
    featuresBadge: "Why Mermaid Charts",
    featuresH2a: "Everything You Need to",
    featuresH2b: "Visualize Your PRD with Mermaid",
    featuresDesc: "From text to professional mermaid diagrams in seconds.",
    feat1Title: "Mermaid Sequence Diagram",
    feat1Desc: "Automatically extract user-system interactions from your PRD and generate clean mermaid sequence diagrams.",
    feat2Title: "Mermaid Flowchart",
    feat2Desc: "Transform business processes and workflows into clear, professional mermaid flowchart diagrams instantly.",
    feat3Title: "Mermaid User Journey Map",
    feat3Desc: "Convert user stories and requirements into comprehensive mermaid user journey diagrams.",
    ...
    galleryTitle: "See Mermaid Diagram Results",
    galleryDesc: "From PRD text to professional mermaid diagrams",
    ...
    // Footer
    footerTagline: "AI-powered PRD to mermaid chart & diagram generator for product managers.",
    ...
    // Meta
    pageTitle: "PRD Chart - AI Mermaid Chart & Diagram Generator from PRD",
    pageDescription: "Generate mermaid charts and diagrams from your PRD instantly. AI-powered mermaid sequence diagrams, flowcharts, and user journey maps. Built for product managers.",
  ...
  zh: {
    ...
    heroH1b: "图表，一键生成",
    heroDesc: "专为产品经理和程序员打造。上传 PRD，AI 即时生成 Mermaid 时序图、流程图、旅程地图。",
    heroCTA: "开始生成",
    heroDemo: "查看示例",
    ...
    workspaceBadge: "AI 驱动的 Mermaid 图表生成",
    workspaceH2: "将您的 PRD 转化为 Mermaid 图表",
    workspaceDesc: "粘贴您的 PRD 文本或上传 .txt 文件。我们的 AI 将即时分析并生成专业 Mermaid 图表。",
    typeLabel: "图表类型",
    typeSequence: "时序图",
    typeSequenceDesc: "Mermaid 时序图流程",
    typeFlowchart: "流程图",
    typeFlowchartDesc: "Mermaid 流程图可视化",
    typeJourney: "用户旅程地图",
    typeJourneyDesc: "Mermaid 旅程地图",
    generateBtn: "生成图表",
    downloadBtn: "下载 Mermaid 图表",
    resetBtn: "处理其他 PRD",
    viewMode: "观看模式",
    ...
    doneLabel: "Mermaid 图表生成成功",
    sliderHint: "预览生成的 Mermaid 图表",
    resolution: "分辨率",
    preview: "预览",
    change: "更换",
    labelOriginal: "原始文本",
    labelEnhanced: "生成的 Mermaid 图表",

    featuresBadge: "为什么选择 Mermaid 图表",
    featuresH2a: "用 Mermaid",
    featuresH2b: "可视化你的 PRD",
    featuresDesc: "几秒内从文本到专业 Mermaid 图表。",
    feat1Title: "Mermaid 时序图",
    feat1Desc: "从 PRD 中自动提取用户与系统的交互，生成清晰的 Mermaid 时序图。",
    feat2Title: "Mermaid 流程图",
    feat2Desc: "将业务流程和工作流程即时转化为清晰专业的 Mermaid 流程图。",
    feat3Title: "Mermaid 用户旅程地图",
    feat3Desc: "将用户故事和需求转化为全面的 Mermaid 用户旅程图。",
    feat4Title: "多格式支持",
    ...
    galleryTitle: "查看 Mermaid 图表效果",
    galleryDesc: "从 PRD 文本到专业 Mermaid 图表",
    galArch: "时序图",
    galPortrait: "流程图",
    galWildlife: "用户旅程",
    ...
    footerTagline: "面向产品经理的 AI Mermaid 图表生成工具。",
    footerNote: "以神经网络精度构建 · 由 AI 驱动",
    footerCopy: "© 2026 PRD Chart Inc. 保留所有权利。",
    ...
    pageTitle: "PRD Chart - AI Mermaid图表生成器，PRD一键转Mermaid图表",
    pageDescription: "上传PRD文档，AI自动生成Mermaid时序图、流程图、用户旅程地图。专为产品经理打造的Mermaid图表生成工具。",
