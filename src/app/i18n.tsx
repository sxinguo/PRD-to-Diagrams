...
export const translations = {
  en: {
    ...
    feat2Desc: "Transform business processes and workflows into clear, professional flowchart diagrams instantly.",
    feat3Title: "User Journey Map",
    feat3Desc: "Convert user stories and requirements into comprehensive user journey diagrams.",
    ...
    galleryTitle: "See Diagram Results",
    ...
    // Footer
    footerTagline: "AI-powered PRD chart & diagram generator for product managers.",
    ...
    pageDescription: "Generate diagrams from your PRD instantly. AI-powered sequence diagrams, flowcharts, and user journey maps. Built for product managers.",
  ...
  zh: {
    ...
    footerTagline: "面向产品经理的 AI 图表生成工具。",
    ...
    pageTitle: "PRD Chart - AI Mermaid图表生成器，PRD一键转图表",
    pageDescription: "上传 PRD 文档，AI 自动生成时序图、流程图、用户旅程地图。专为产品经理打造的 AI 图表生成工具。",
